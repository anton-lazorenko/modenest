  ...
  return (
    <section className="relative h-[100vh] w-full flex items-start justify-center pt-[240px] overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 text-left flex flex-col gap-8 pt-24">
        <div className="max-w-xld w-max flex flex-col gap-2 p-14 rounded-xl">
          <h1 className="text-5xl md:text-6xl font-extrabold text-amber-100 mb-4">
          ...
          <FancyButton onClick={() => router.push("/products")} className={"max-w-[300px] relative cursor-pointer overflow-hidden px-24 py-8 border border-amber-100 rounded-full group"}>
            Shop Now
          </FancyButton>
        </div>
      </div>
